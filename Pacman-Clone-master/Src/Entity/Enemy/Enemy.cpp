	...
	: Entity(gameState, entityType)
{
	...
	if (texture.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(texturePos.x, texturePos.y, 14, 14)))
...
void Enemy::ChangeAnimation()
{
	if (state != EnemyState::Frightened)
	{
		if (state == EnemyState::Eaten_Retreating)
		{
			...
			{
			case Left:
				if (texture.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(374, 81, 14, 14)))
					body.setTexture(&texture);
				break;
			case Right:
				if (texture.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(358, 81, 14, 14)))
					body.setTexture(&texture);
				break;
			case Up:
				if (texture.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(390, 81, 14, 14)))
					body.setTexture(&texture);
				break;
			case Down:
				if (texture.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(406, 81, 14, 14)))
					body.setTexture(&texture);
				break;
			case None:
				break;
...
void Enemy::SetupAnimations()
{
	...
	f1.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(358, 65, 14, 14));
	f2.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(374, 65, 14, 14));
	ff1.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(390, 65, 14, 14));
	ff2.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(406, 65, 14, 14));
