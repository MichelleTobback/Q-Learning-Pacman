...
void Inky::SetupAnimations()
{
	...
	r1.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(230, 97, 14, 14));
	r2.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(246, 97, 14, 14));
	l1.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(262, 97, 14, 14));
	l2.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(278, 97, 14, 14));
	std::vector<sf::Texture> leftAnimTextures{ l1,l2 };
	std::vector<sf::Texture> rightAnimTextures{ r1,r2 };

	sf::Texture u1, u2, d1, d2;
	u1.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(294, 97, 14, 14));
	u2.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(310, 97, 14, 14));
	d1.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(326, 97, 14, 14));
	d2.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(342, 97, 14, 14));
