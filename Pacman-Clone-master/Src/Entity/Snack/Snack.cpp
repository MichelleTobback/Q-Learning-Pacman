    ...
    : Entity(gameState, Entities::NotDefined)
{
    ...
    if (type == SmallSnack)
    {
        ...
        texture.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(226, 240, 7, 7));
    }
    else
    {
        body = sf::RectangleShape(sf::Vector2f(gameState->tileWidth, gameState->tileHeight));
        texture.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(233, 240, 8, 8));
        SetupAnimation();
...
{
    delete animator;
    delete bigSnackFlickerAnimation;
}
...
void Snack::SetupAnimation()
{
    ...
    spriteOn.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(233, 240, 8, 8));
    spriteOff.loadFromFile("Pacman-Clone-master/Resources/PacManSprites.png", sf::IntRect(230, 160, 8, 8));
